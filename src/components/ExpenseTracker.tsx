    ...
    <div className="expense-tracker">
      <div className="tracker-layout">
        ...
        <div className="add-panel">
          ...
          <div className="month-summary">
            ...
            <div className="summary-row">
              <span>Spent</span>
              <strong>{fmt(monthlySpent)}</strong>
            </div>
            <div className="summary-row">
              <span>Budget</span>
            ...
            <div className="summary-bar-track">
              <div
                ...
                style={{
                  width: `${Math.min((monthlySpent / totalBudget) * 100, 100)}%`,
        ...
        <div className="list-panel">
          ...
          {filtered.length === 0 ? (
            <div className="list-empty">No expenses {filter !== "all" ? `in ${CATEGORIES[filter].label}` : "yet"}</div>
          ) : (
                  ...
                  {items.map((e) => {
                    ...
                    return (
                      <div key={e.id} className="expense-row">
                        <div className="exp-icon" style={{ background: `${info.color}15` }}>
                          {info.icon}
                        </div>
                        ...
                        <button
                          className={`del-btn ${confirmId === e.id ? "confirm" : ""}`}
